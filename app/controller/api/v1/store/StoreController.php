...
class StoreController
{
	...
	* @throws \think\db\exception\ModelNotFoundException
    ...
    {
        [$latitude, $longitude,$id, $store_id] = $request->getMore([
            ['latitude', ''],
            ['longitude', ''],
            ['id', 2],
            ['store_id', 0]//选择具体门店
	...
	* @throws \think\db\exception\ModelNotFoundException
	...
	{
		[$store_type, $keywords, $latitude, $longitude,$cate_id] = $request->getMore([
			['store_type', 1],
			['keyword', ''],
            ['latitude', ''],
            ['longitude', ''],
		...
		$where = ['uid' => (int)$request->uid(), 'store_type' => $store_type, 'keywords' => $keywords,'id'=>0];
		if($cate_id) {
