...
class UserController
{
    ...
    {
        [$avatar,$fuyou_pwd, $nickname,$extend_info] = $request->postMore([
            ['avatar', ''],
            ['fuyou_pwd',null],
            ['nickname', ''],
            ['extend_info', []]
        ...
        $uid = (int)$request->uid();
        $this->services->saveExtendForm($uid, $extend_info, ['fuyou_pwd' => $fuyou_pwd,'avatar' => $avatar, 'nickname' => $nickname], true);
