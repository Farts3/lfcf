      ...
      <div class="table_box">
        ...
        <div class="right_box" v-if="currenType=='special' || currenType=='product_category' || currenType=='product' || currenType=='seckill' || currenType == 'bargain' || currenType == 'combination' || currenType == 'news' || currenType == 'integral'">
          ...
          <Table
              ...
              :data="tableList"
              :loading="loading"
              :max-height="currenType=='product_category'?'410':( currenType=='seckill' || currenType == 'bargain' || currenType == 'combination' || currenType == 'news' || currenType == 'integral')?'400':currenType=='product'?'356':''"
          >
