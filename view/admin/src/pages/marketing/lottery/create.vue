        ...
        <Col span="23">
          ...
          >
            ...
            <!--      <div class="acea-row row-middle">
              ...
              <Col span="24" v-if="formValidate.factor == 1" key="total_lottery_num">
                <FormItem
                  label="每人抽奖总次数："
                ...
                >
                  <div class="input-number-wrapper perW20">
                    <InputNumber v-model="formValidate.total_lottery_num" :min="1" element-id="total_lottery_num"></InputNumber>
              ...
              <Col span="24" v-if="formValidate.factor == 1" key="lottery_num2">
                ...
                >
                  <div class="input-number-wrapper perW20">
                    <InputNumber v-model="formValidate.lottery_num" :min="1" element-id="lottery_num2"></InputNumber>
                    <div class="suffix">次</div>
                  </div>
                </FormItem>
              </Col>
