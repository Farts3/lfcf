 ...
 * @param {*} data
 */
export const uploadToBulkRecharge = data => {
  return request({
    url: 'file/upload/1',
    method: 'post',
    data,
 ...
 * @param {*} data
 */
export const postBulkRecharge = data => {
  return request({
    url: 'user/import_user_money ',
    method: 'post',
    data
  })
}
 ...
 * @param {*} data
 */
export const getExportUserList = params => {
  return request({
    url: 'export/exportUser',
    method: 'get',
    params
  })
}
