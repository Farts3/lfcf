				  ...
				  ></DatePicker> -->
					...
					<Col  class="mr">
						<FormItem label="选择店员："  label-for="status1">
							<Select v-model="formValidate.staff_id" placeholder="请选择" style="width: 200px" clearable element-id="status1" @on-change="searchs">
					...
					<Col  class="mr">
						<FormItem label="订单搜索："  label-for="status1">
							<Input v-model="formValidate.keywork" placeholder="请输入交易单号/交易人" class="input" style="width: 200px"></Input>
						</FormItem>
					</Col>
					<Col class="mr">
