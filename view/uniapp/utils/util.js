		...
		if(arr.length>1){
		 ...
		 //#endif
			...
			if (url.indexOf("http") != -1) {
				...
				if (['/pages/goods_cate/goods_cate','/pages/two_open/storeCategory', '/pages/order_addcart/order_addcart', '/pages/user/index', '/pages/index/index','/pages/store_cate/store_cate']
					.indexOf(url) == -1) {
					uni.navigateTo({
						url: url
					})
