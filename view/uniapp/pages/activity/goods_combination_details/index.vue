<template>
	<view :style="colorStyle">
		...
		<product-window :attr='attribute' :limitNum='1' :cusPreviewImg='1' :productType="storeInfo.product_type" :productId="storeInfo.product_id" @myevent="onMyEvent" @ChangeAttr="ChangeAttr"
