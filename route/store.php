...
Route::group('storeapi', function () {
    ...
    Route::group('finance', function () {
        ...
        // zz Start
        Route::get('store_finance_flow/offlinelogs', 'finance.StoreFinanceFlow/offlinelogs')->option(['real_name' => '门店线下账单']);
        Route::post('store_finance_flow/offlineRefund', 'finance.StoreFinanceFlow/offlineRefund')->option(['real_name' => '门店线下账单-退款']);
        // zz END
